...
import { Brand } from 'src/app/model-dto/brand/brand';
import { BrandResponse } from 'src/app/model-dto/brand/brandResponse';
import { Category } from 'src/app/model-dto/category/category';
import { CategoryResponse } from 'src/app/model-dto/category/categoryResponse';
import { CategoryHierarchy } from 'src/app/model-dto/category/categoryHierarchy';
import { FileHandle } from 'src/app/model-dto/file-handle.model';
import { Product } from 'src/app/model-dto/product/product';
import { ProductDTO } from 'src/app/model-dto/product/productDTO';
import { CategorylistService } from 'src/app/_services/categorylist.service';
import { NgForm } from '@angular/forms';
import { DomSanitizer } from '@angular/platform-browser';
import { ProductDetails } from 'src/app/model-dto/product/productDetails';
...
export class ProductUpdateComponent implements OnInit, AfterViewInit{
  ...
  constructor(private productService: ProductService,
    ...
    // this.categoriesListHierarchy = this.categorylistService.getAllCategoriesListWithHierarchy();
  ...
  public updateProduct(productForm: NgForm, productId: number){
    ...
    this.productService.updateProductById(formData, productId).subscribe({
